...
My implementations are located in [multiagent/multiAgents.py](multiagent/multiAgents.py).

## Report with Minimax agent (Question 2)

Command: `python3 autograder.py -q q2 --no-graphics`

```.
Starting on 10-10 at 12:17:33
...
## Report from Alpha-Beta Agent (Question 3)

Command: `python3 autograder.py -q q3 --no-graphics`

```.
Starting on 10-10 at 12:17:59
